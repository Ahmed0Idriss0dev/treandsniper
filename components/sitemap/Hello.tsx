    ...
    <main className='flex justify-center flex-col items-center -z-0  min-h-[60dvh] w-full px-6 sm:px-11 md:px-14'>
      <div className="flex justify-center flex-col items-center gap-4">
        <div className="text-center">
          <h1 className='text-2xl text-transparent bg-clip-text bg-linear-90 from-treand-700 to-red-500 sm:text-4xl'>Snipe Trending Digital Products <br className='sm:block hidden' /> Before They Go Mainstream</h1>
