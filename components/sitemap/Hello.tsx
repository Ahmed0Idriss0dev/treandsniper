...
const Hello = () => {
  return (
    <main className='flex justify-center flex-col items-center -z-0  min-h-[60dvh] w-full p-14'>
      ...
      <Link className='button bg-black text-white w-46 rounded-2xl flex justify-center items-center ' href="/tools">Dasbourd</Link>
        <Providers/>
      </div>
    </main>
  )
